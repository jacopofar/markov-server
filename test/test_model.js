...
var Persistor = require('../SQLItePersistor');

describe('MarkovModel', function() {
  describe('learn', function () {
    it('should return only successors among the given ones', function () {
    ...
    it('should work with orders greater than 1', function () {
      var mm = new MarkovModel(new Persistor('test2'));
      mm.learn(mm.aggregateStates('12345678901234567890'
      .split(''),4));
